...
async function runTest() {
  ...
  const nfvsUser = {
    ...
    roleCode: nfvsUserDb.role.code as any,
    roleLevel: nfvsUserDb.role.level,
    dataScope: nfvsUserDb.role.dataScope as any,
  ...
  const nareeUser = {
    ...
    roleCode: nareeUserDb.role.code as any,
    roleLevel: nareeUserDb.role.level,
    dataScope: nareeUserDb.role.dataScope as any,
